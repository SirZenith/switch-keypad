...
#define KEY_LEFT_CTRL \
    { Operation::NAME, KEY_LEFT_CTRL }
#define KEY_LEFT_SHIFT \
    { Operation::NAME, KEY_LEFT_SHIFT }
#define KEY_LEFT_ALT \
    { Operation::NAME, KEY_LEFT_ALT }
#define KEY_LEFT_GUI \
    { Operation::NAME, KEY_LEFT_GUI }
#define KEY_RIGHT_CTRL \
    { Operation::NAME, KEY_RIGHT_CTRL }
#define KEY_RIGHT_SHIFT \
    { Operation::NAME, KEY_RIGHT_SHIFT }
#define KEY_RIGHT_ALT \
    { Operation::NAME, KEY_RIGHT_ALT }
#define KEY_RIGHT_GUI \
    { Operation::NAME, KEY_RIGHT_GUI }

#define KEY_UP_ARROW \
    { Operation::NAME, KEY_UP_ARROW }
#define KEY_DOWN_ARROW \
    { Operation::NAME, KEY_DOWN_ARROW }
#define KEY_LEFT_ARROW \
    { Operation::NAME, KEY_LEFT_ARROW }
#define KEY_RIGHT_ARROW \
    { Operation::NAME, KEY_RIGHT_ARROW }
#define KEY_BACKSPACE \
    { Operation::NAME, KEY_BACKSPACE }
#define KEY_TAB \
    { Operation::NAME, KEY_TAB }
#define KEY_RETURN \
    { Operation::NAME, KEY_RETURN }
#define KEY_ESC \
    { Operation::NAME, KEY_ESC }
#define KEY_INSERT \
    { Operation::NAME, KEY_INSERT }
#define KEY_DELETE \
    { Operation::NAME, KEY_DELETE }
#define KEY_PAGE_UP \
    { Operation::NAME, KEY_PAGE_UP }
#define KEY_PAGE_DOWN \
    { Operation::NAME, KEY_PAGE_DOWN }
#define KEY_HOME \
    { Operation::NAME, KEY_HOME }
#define KEY_END \
    { Operation::NAME, KEY_END }
#define KEY_CAPS_LOCK \
    { Operation::NAME, KEY_CAPS_LOCK }
#define KEY_F1 \
    { Operation::NAME, KEY_F1 }
#define KEY_F2 \
    { Operation::NAME, KEY_F2 }
#define KEY_F3 \
    { Operation::NAME, KEY_F3 }
#define KEY_F4 \
    { Operation::NAME, KEY_F4 }
#define KEY_F5 \
    { Operation::NAME, KEY_F5 }
#define KEY_F6 \
    { Operation::NAME, KEY_F6 }
#define KEY_F7 \
    { Operation::NAME, KEY_F7 }
#define KEY_F8 \
    { Operation::NAME, KEY_F8 }
#define KEY_F9 \
    { Operation::NAME, KEY_F9 }
#define KEY_F10 \
    { Operation::NAME, KEY_F10 }
#define KEY_F11 \
    { Operation::NAME, KEY_F11 }
#define KEY_F12 \
    { Operation::NAME, KEY_F12 }
#define KEY_F13 \
    { Operation::NAME, KEY_F13 }
#define KEY_F14 \
    { Operation::NAME, KEY_F14 }
#define KEY_F15 \
    { Operation::NAME, KEY_F15 }
#define KEY_F16 \
    { Operation::NAME, KEY_F16 }
#define KEY_F17 \
    { Operation::NAME, KEY_F17 }
#define KEY_F18 \
    { Operation::NAME, KEY_F18 }
#define KEY_F19 \
    { Operation::NAME, KEY_F19 }
#define KEY_F20 \
    { Operation::NAME, KEY_F20 }
#define KEY_F21 \
    { Operation::NAME, KEY_F21 }
#define KEY_F22 \
    { Operation::NAME, KEY_F22 }
#define KEY_F23 \
    { Operation::NAME, KEY_F23 }
#define KEY_F24 \
    { Operation::NAME, KEY_F2 }
